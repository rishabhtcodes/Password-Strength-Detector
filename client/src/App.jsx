    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10">
        ...
        <div className="mb-10 text-center">
          <h2 className="mb-3 text-4xl font-bold tracking-tight text-cyber-text sm:text-5xl">
            Password Strength{" "}
            <span className="text-cyber-accent">Analyzer</span>
          </h2>
        ...
        {/* Main Card */}
        <div className="stagger-children space-y-6 rounded-2xl border border-cyber-border bg-cyber-card/95 p-6 shadow-2xl backdrop-blur-md">
          {/* Password Input */}
          ...
          {password.length > 0 && (
            <button
              ...
              disabled={loading}
              className="w-full rounded-xl bg-gradient-to-r from-cyber-accent to-cyber-accent-dim py-3.5 text-sm font-bold text-white transition-all hover:shadow-lg hover:shadow-cyber-accent/25 active:scale-[0.98] disabled:opacity-50"
            >
              {loading ? (
            ...
            <div className="animate-slide-in rounded-xl border border-cyber-accent/20 bg-cyber-accent/5 p-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-lg bg-cyber-bg/50 p-3">
                  ...
                  <p className="mt-1 font-mono text-lg font-bold text-cyber-text">
        ...
        <div className="mt-6">
          ...
          {/* How it works */}
        <div className="mt-8">
          <h3 className="mb-4 text-center text-sm font-semibold text-cyber-text">
            How It Works
          </h3>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            {[
              ...
              <div
                key={i}
                className="rounded-xl border border-cyber-border bg-cyber-card/90 p-4 text-center backdrop-blur-md transition-all hover:border-cyber-accent/30 hover:bg-cyber-card"
              >
                ...
                <h4 className="text-xs font-semibold text-cyber-text">{step.title}</h4>
